import sys
from PyQt5.QtWidgets import QApplication, QPushButton , QWidget, QLabel, QVBoxLayout, QLineEdit, QTextEdit, QHBoxLayout
...
# Calculate button (optional, can be removed if not needed)
# calculate_button = QPushButton("Calculate")
# calculate_button.setFont(QFont("Arial", 14))
# calculate_button.setStyleSheet("background-color: #6366f1; color: #ffffff; border: none; padding: 10px 5px;")
